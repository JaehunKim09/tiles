                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" name="Login" action="/study/index" method="get" id="frm" >
                                        ...
                                        <hr>
                                        <a href="/study/index" class="btn btn-google btn-user btn-block">
                                            <i class="fab fa-google fa-fw"></i> Login with Google
                                        </a>
                                        <a href="/study/index" class="btn btn-facebook btn-user btn-block">
